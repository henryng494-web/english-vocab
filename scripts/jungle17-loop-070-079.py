#!/usr/bin/env python3
"""Emit next GenerateImage call JSON for agent loop (070-079). Sanitized on blocks."""
...
def counts():
    ...
    return {"batches":"070-079","total":len(jobs),"generated":have,"skipped":have,"pending":len(jobs)-have}
...
json.dump(out, open("/tmp/jungle17-current.json","w"), ensure_ascii=False)
