#!/usr/bin/env npx tsx
/** Copy bundle artifacts → public/word-images/{word}.jpg (default jungle16). */
import { existsSync, readFileSync } from "node:fs";
import { execSync } from "node:child_process";

const BUNDLE = process.env.JUNGLE_BUNDLE ?? "jungle16";
const JOBS = process.env.JUNGLE_JOBS ?? "/tmp/jungle16-jobs.jsonl";
