/**
 * Example: Gemini → Pexels vocabulary illustration pipeline.
 *
 * Usage:
 *   npm run test:gemini-pexels-image
 *   npx tsx scripts/test-gemini-pexels-image.ts devoted adjective "Tận tụy, hết lòng"
 */
...
} from "../src/lib/gemini-pexels-image";
...
async function main() {
  ...
  if (phrase) {
    console.log("\n=== Step 2: Pexels image ===");
    const pexelsUrl = await fetchPexelsImageUrl(phrase);
    console.log("Pexels URL:", pexelsUrl ?? "(null)");
  }
