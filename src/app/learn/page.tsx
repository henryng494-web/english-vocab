      ...
      <header className="border-b border-white/60 bg-white/80 backdrop-blur-md">
        <div className="mx-auto max-w-2xl px-4 py-4">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-xl font-bold text-slate-900">English Vocab</h1>
              <p className="text-sm text-slate-500">WordUp-style flashcards</p>
            </div>
      ...
      <div className="mx-auto max-w-2xl px-4 py-6">
        <form onSubmit={handleAddWord} className="flex gap-2">
          <input
            ...
            className="flex-1 rounded-xl border border-slate-200 bg-white px-4 py-3 text-slate-900 shadow-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
          />
          <button
            type="submit"
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 flex items-center justify-center gap-3">
              <button
                ...
                className="rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-600 shadow-sm disabled:opacity-40"
              >
                ← Trước
              </button>
              <button
