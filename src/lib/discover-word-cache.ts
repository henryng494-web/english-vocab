...
import { isUntrustedRandomImageUrl } from "@/lib/unsplash";

/** Bump when example/image quality rules or enrichment output shape changes. */
export const DISCOVER_WORD_CACHE_VERSION = 9;
