...
export const messages: Record<AppLocale, MessageTree> = {
  vi: {
    ...
    "menu.homeLayoutHint": "Chọn 1 trong 5 trang chủ — áp dụng ngay, không có buổi học session.",
    "menu.homeLayout1": "Daily Hub",
    "menu.homeLayout1Desc": "Stats · banner khỉ · mục tiêu · tiếp theo",
    "menu.homeLayout2": "Dashboard",
    "menu.homeLayout2Desc": "Banner nổi · 3 thẻ ôn/thư viện/cấp · streak",
    "menu.homeLayout3": "Center Stage",
    "menu.homeLayout3Desc": "Stats · khỉ giữa · 3 ô · mục tiêu",
    "menu.homeLayout4": "Magazine",
    "menu.homeLayout4Desc": "Banner ngang · lối tắt · tiến độ",
    "menu.homeLayout5": "Bubble",
    "menu.homeLayout5Desc": "Banner tím · lưới 4 số · ôn nhanh",
    ...
    "home.layoutGalleryLink": "Xem 5 layout trang chủ →",
    "home.layoutGalleryTitle": "Layout trang chủ",
    "home.layoutGalleryHint": "Chọn một trong 5 layout — banner chính là Học từ mới với khỉ Jungle Jokers.",
    "home.layoutGalleryChoose": "Dùng layout này",
    "home.layoutGallerySelected": "Đang dùng · về trang chủ",
    "home.layoutLivePreview": "Xem thực tế ↓",
    "home.wireframeHeader": "Header",
    "home.wireframeBanner": "Banner · Học từ mới + khỉ",
    "home.wireframeSubtitle": "123 từ · Cấp 1–300",
    "home.wireframeProgress": "Tiến độ cấp từ",
    "home.wireframeMiniStats": "Streak + mục tiêu",
    "home.wireframeCoins": "Đồng xu",
    "home.wireframeGoal": "Mục tiêu",
    "home.wireframeCaption": "Sơ đồ khung — không có session, banner chính là Học từ mới",
  ...
  en: {
    ...
    "menu.homeLayoutHint": "Pick one of five full home pages — applies instantly, no daily session.",
    "menu.homeLayout1": "Daily Hub",
    "menu.homeLayout1Desc": "Stats · monkey banner · goal · up next",
    "menu.homeLayout2": "Dashboard",
    "menu.homeLayout2Desc": "Float banner · review/library/rank cards · streak",
    "menu.homeLayout3": "Center Stage",
    "menu.homeLayout3Desc": "Stats · center monkey · 3 tiles · goal",
    "menu.homeLayout4": "Magazine",
    "menu.homeLayout4Desc": "Wide banner · shortcuts · progress",
    "menu.homeLayout5": "Bubble",
    "menu.homeLayout5Desc": "Purple banner · 4-stat grid · quick review",
    ...
    "home.layoutGalleryLink": "Browse 5 home layouts →",
    "home.layoutGalleryTitle": "Home layouts",
    "home.layoutGalleryHint": "Pick one of five layouts — main banner is Learn new words with the Jungle Jokers monkey.",
    "home.layoutGalleryChoose": "Use this layout",
    "home.layoutGallerySelected": "Active · back to home",
    "home.layoutLivePreview": "Live preview ↓",
    "home.wireframeHeader": "Header",
    "home.wireframeBanner": "Banner · Learn new words + monkey",
    "home.wireframeSubtitle": "123 words · Rank 1–300",
    "home.wireframeProgress": "Rank progress",
    "home.wireframeMiniStats": "Streak + goal",
    "home.wireframeCoins": "Coins",
    "home.wireframeGoal": "Goal",
    "home.wireframeCaption": "Wireframe — no session; main banner is Learn new words",
