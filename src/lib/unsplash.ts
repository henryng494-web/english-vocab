...
export function getDefaultLearningImageDataUrl(): string {
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="600" height="350" viewBox="0 0 600 350">
    ...
    <g fill="#ffffff" opacity="0.95">
      ...
      <rect x="230" y="165" width="140" height="10" rx="4" fill="#FF7900"/>
      <rect x="230" y="185" width="110" height="8" rx="4" fill="#FF7900"/>
      <rect x="230" y="201" width="120" height="8" rx="4" fill="#FF7900"/>
      <rect x="230" y="217" width="90" height="8" rx="4" fill="#FF7900"/>
      <circle cx="300" cy="110" r="34" fill="#ffffff"/>
      <path d="M300 90 l40 18 -40 18 -40 -18 z" fill="#FF7900"/>
      <rect x="278" y="112" width="6" height="26" fill="#FF7900"/>
    </g>
  </svg>`;
  const base64 =
