...
> = {
  sorry: {
    ...
    scene:
      "Purple monkey offering a small flower bouquet with both long arms to pink elephant sitting with drooped ears on a jungle bench after a broken clay pot on the ground.",
    expressions:
  ...
  yes: {
    ...
    scene:
      "All four jungle mascots at a rainforest picnic celebrating — green checkmark flag planted in a fruit cake, confetti leaves in air, sunny jungle clearing.",
    expressions:
  ...
  no: {
    ...
    scene:
      "Purple monkey and orange tiger firmly refuse a giant tempting honey jar offered by a shadowy hand from off-screen — arms crossed, stepping back in jungle camp.",
    expressions:
  ...
  think: {
    ...
    scene:
      "Purple monkey at a tree-stump desk with puzzle pieces and a half-built vine tower, one hand on chin, looking up at floating curved hook shapes (no letters).",
    expressions:
  ...
  love: {
    ...
    scene:
      "All four mascots forming a group hug in front of a jungle waterfall at golden sunset, small floating heart shapes (no text) in warm orange-pink sky.",
    expressions:
