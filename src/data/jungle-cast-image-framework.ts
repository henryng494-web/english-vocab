/**
 * Jungle Jokers — locked image-generation framework (rank 1–2999, 3000–5000).
 ...
 */
export const CAST_WORD_IMAGE_BUNDLE = "jungle17";
...
export const JUNGLE_CAST_FRAMEWORK_VERSION = "jungle17-v1";
