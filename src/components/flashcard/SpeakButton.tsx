...
export function SpeakButton({
  ...
  const className = iconOnly
    ? variant === "light"
      ? "inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-primary-200 bg-primary-50 text-primary-700 transition hover:bg-primary hover:text-white disabled:opacity-60"
    ...
    : variant === "light"
      ? "inline-flex items-center gap-2 rounded-full border border-primary-200 bg-primary-50 px-4 py-2 text-sm font-medium text-primary-700 transition hover:bg-primary hover:text-white disabled:opacity-60"
